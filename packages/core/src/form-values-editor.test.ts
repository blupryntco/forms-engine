...
describe('FormValuesEditor — construction', () => {
...
// ════════════════════════════════════════════════════════════════════════════
// 2. getFieldValue / setFieldValue / clearFieldValue
// ════════════════════════════════════════════════════════════════════════════

describe('FormValuesEditor — getFieldValue / setFieldValue / clearFieldValue', () => {
    ...
    it('clearFieldValue removes the key', () => {
        ...
        expect('1' in editor.getDocument().values).toBe(false)
    })
...
describe('FormValuesEditor — array operations', () => {
...
describe('FormValuesEditor — setSubmittedAt', () => {
    it('updates document submittedAt', () => {
        const editor = new FormValuesEditor(simpleDef)
        editor.setSubmittedAt('2026-01-01T00:00:00.000Z')
        expect(editor.getDocument().form.submittedAt).toBe('2026-01-01T00:00:00.000Z')
    })
})
...
describe('FormValuesEditor — validate', () => {
...
describe('FormValuesEditor — visibility', () => {
...
describe('FormValuesEditor — output', () => {
    it('getDocument returns deep clone', () => {
        const editor = new FormValuesEditor(simpleDef)
        editor.setFieldValue(1, 'Alice')
    ...
    it('toJSON is an alias for getDocument', () => {
        const editor = new FormValuesEditor(simpleDef)
        editor.setFieldValue(1, 'Alice')
        expect(editor.toJSON()).toEqual(editor.getDocument())
    })
...
describe('FormValuesEditor — fluent chaining', () => {
