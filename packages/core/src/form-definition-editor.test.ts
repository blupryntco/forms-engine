...
import type { ContentItem, FormDefinition } from './types'
...
describe('FormDefinitionEditor — construction', () => {
...
describe('FormDefinitionEditor — meta', () => {
    it('setTitle', () => {
...
describe('FormDefinitionEditor — nextId', () => {
...
describe('FormDefinitionEditor — addField', () => {
    ...
    it('throws on duplicate id', () => {
        ...
        expect(() => editor.addField({ id: 1, type: 'number', label: 'B' })).toThrow('Item with id 1 already exists')
    })
    ...
    it('adds array field with item definition', () => {
        ...
        const field = editor.toJSON().content[0]! as any
...
describe('FormDefinitionEditor — addSection', () => {
...
describe('FormDefinitionEditor — updateField', () => {
    ...
    it('updates validation', () => {
        ...
        expect((editor.toJSON().content[0] as any).validation).toEqual({
            required: true,
            minLength: 2,
        })
    })
...
describe('FormDefinitionEditor — updateSection', () => {
...
describe('FormDefinitionEditor — removeItem', () => {
...
describe('FormDefinitionEditor — moveItem', () => {
...
describe('FormDefinitionEditor — listing', () => {
    const editor = new FormDefinitionEditor(
        defWith([
...
// ════════════════════════════════════════════════════════════════════════════
// 11. Field-specific setters
// ════════════════════════════════════════════════════════════════════════════

describe('FormDefinitionEditor — setValidation', () => {
    ...
    it('clears validation', () => {
        ...
        expect((editor.toJSON().content[0] as any).validation).toBeUndefined()
    })
...
describe('FormDefinitionEditor — setCondition', () => {
    it('sets a simple condition', () => {
        ...
        expect((editor.toJSON().content[1] as any).condition).toEqual({
            field: 1,
            op: 'set',
        })
    })
    ...
    it('sets a compound condition', () => {
        ...
        expect((editor.toJSON().content[2] as any).condition).toEqual({
            and: [
                { field: 1, op: 'set' },
                { field: 2, op: 'gt', value: 10 },
            ],
    ...
    it('clears a condition', () => {
        ...
        expect((editor.toJSON().content[0] as any).condition).toBeUndefined()
    })
...
describe('FormDefinitionEditor — setOptions', () => {
    it('sets options on a select field', () => {
        ...
        expect((editor.toJSON().content[0] as any).options).toHaveLength(3)
    })
...
describe('FormDefinitionEditor — setArrayItem', () => {
    it('sets item definition on an array field', () => {
        ...
        expect((editor.toJSON().content[0] as any).item).toEqual({
            type: 'number',
            label: 'Score',
            validation: { min: 0, max: 100 },
        })
...
describe('FormDefinitionEditor — setLabel', () => {
    it('sets label on a field', () => {
        const editor = new FormDefinitionEditor(defWith([{ id: 1, type: 'string', label: 'Old' }]))
        editor.setLabel(1, 'New')
        expect((editor.toJSON().content[0] as any).label).toBe('New')
    })
...
describe('FormDefinitionEditor — setDescription_item', () => {
    it('sets description on a field', () => {
        const editor = new FormDefinitionEditor(defWith([{ id: 1, type: 'string', label: 'A' }]))
        editor.setDescription_item(1, 'Help text')
        expect((editor.toJSON().content[0] as any).description).toBe('Help text')
    })

    it('clears description', () => {
        const editor = new FormDefinitionEditor(defWith([{ id: 1, type: 'string', label: 'A', description: 'D' }]))
        editor.setDescription_item(1, undefined)
        expect((editor.toJSON().content[0] as any).description).toBeUndefined()
    })

    it('sets description on a section', () => {
        const editor = new FormDefinitionEditor(defWith([{ id: 1, type: 'section', title: 'S', content: [] }]))
        editor.setDescription_item(1, 'Section help')
        expect((editor.toJSON().content[0] as any).description).toBe('Section help')
    })
})

// ════════════════════════════════════════════════════════════════════════════
// 12. toJSON deep clones
// ════════════════════════════════════════════════════════════════════════════

describe('FormDefinitionEditor — toJSON', () => {
...
describe('FormDefinitionEditor — fluent chaining', () => {
