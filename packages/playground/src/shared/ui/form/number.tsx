...
import type { NumberEditProps, NumberViewProps } from '@bluprynt/forms-viewer'

import { FieldLabel } from './field-label'

export const NumberView: FC<NumberViewProps> = ({ field, value }) => (
    <div className="mb-4">
...
export const NumberEdit: FC<NumberEditProps> = ({ field, value, errors, onChange }) => {
